...
public class ToDoListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Log.i(TAG, "TODO - Get the current ToDoItem - COMPLETED");
...
//            inflater.inflate(R.layout.todo_item, itemLayout, true);
            LayoutInflater inflater = LayoutInflater.from(mContext);
            inflater.inflate(R.layout.todo_item, itemLayout, true);

        }
        Log.i(TAG, "TODO - Inflate the View for this ToDoItem - COMPLETED");
        ...
        else if(toDoItem.getStatus() == ToDoItem.Status.NOTDONE)
